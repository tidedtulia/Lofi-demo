...
export default function LakeHouse(props: ILakeHouseProps) {
  ...
  return (
    <div className="w-full h-[100vh]">
      ...
      >
        <video
          src={video.lakehouse.outside_day_stoprain}
      ...
      >
        <video
          src={video.lakehouse.outside_day_rain}
          className={style.video}
          autoPlay
          loop
          muted
      ...
      >
        <video
          src={video.lakehouse.outside_night_stoprain}
          className={style.video}
          autoPlay
          loop
          muted
      ...
      >
        <video
          src={video.lakehouse.outside_night_rain}
          className={style.video}
          autoPlay
          loop
          muted
      ...
      >
        <video
          src={video.lakehouse.inside_day_stoprain}
          className={style.video}
          autoPlay
          loop
          muted
      ...
      >
        <video
          src={video.lakehouse.inside_day_rain}
          className={style.video}
          autoPlay
          loop
          muted
      ...
      >
        <video
          src={video.lakehouse.inside_night_stoprain}
          className={style.video}
          autoPlay
          loop
          muted
      ...
      >
        <video
          src={video.lakehouse.inside_night_rain}
          className={style.video}
          autoPlay
          loop
          muted
