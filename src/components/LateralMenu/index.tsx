  ...
  return (
    <div className={style.container}>
      <div className={style.item}>
        <p
          className={`${style.title} ${
            stateMixer ? style.isOpen : style.isClose
          }`}
        >
          Mixer
        </p>
      ...
      <div className={style.item}>
        <p
          className={`${style.title} ${
            stateScenes ? style.isOpen : style.isClose
          }`}
        >
          Scenes
        </p>
      ...
      <div className={style.item}>
        <p
          className={`${style.title} ${
            stateGeneralSetting ? style.isOpen : style.isClose
          }`}
        >
          Setting
        </p>
      ...
      <div className={style.item}>
        <p
          className={`${style.title} ${
            stateTimer ? style.isOpen : style.isClose
          }`}
        >
          Timer
        </p>
      ...
      <MixerPanel state={stateMixer} onClose={() => setStateMixer(false)} />
      <ScenesPanel state={stateScenes} />
      <GeneralSetting state={stateGeneralSetting} />
      <PomodoroTimerPanel
        state={stateTimer}
        onClose={() => setStateTimer(false)}
      />
      <TodosList
        state={stateTodosList}
        onClose={() => setStateTodosList(false)}
      />
    </div>
  );
}
